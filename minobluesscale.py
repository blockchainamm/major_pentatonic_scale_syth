...
def load_notes(notestep, notestep1, notescale):
    ...
    print(f'The frequencies in Hz of notes in the {notescale} minor blues scale in ascending order')
    ...
    print()
    print(f'The frequencies in Hz of notes in the {notescale} minor blues scale in descending order')
