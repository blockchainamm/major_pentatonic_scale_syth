# Program to generate the sounds of notes of a minor blues scale matching the frequencies of notes in piano
...
def load_notes(notestep, notestep1, notescale):
    ...
    # Interval of notes for a minor blues scale
    notes_interval = [3, 2, 1, 1, 3, 2, 2]
    rev_interval = [0, 2, 3, 1, 1, 2, 3]
    tones_fwd, tones_rev = [], []
    
    print(f'The frequencies in Hz of notes with {notescale} as root note minor blues scale in ascending order')
    ...
    print()
    print(f'The frequencies in Hz of notes with {notescale} as root note minor blues scale in descending order')
    ...
    # Return list of frequencies in the ascending and descending notes of the minor blues scale    
...
def fmain(tones_fwd, tones_rev):
    ...
    # Sleep for 1 second before playing the notes of minor blues scale in the descending order
    time.sleep(1)
...
# Scale list for which the minor blues scale will be played in sequence
#scale_list = ['C4']
scale_list = ['Cs4', 'Gs4', 'Fs4', 'E4', 'C5']
